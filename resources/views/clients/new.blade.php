...
<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
    ...
    <li class="nav-item bg-white shadow mb-3 mr-4">
        <a class="nav-link p-3 pr-5 d-flex {{ (isset($societe) || (!$errors->isEmpty() && $errors->has('societe_id'))?'active':'') }}" id="pro-tab" data-toggle="pill" href="#pro" role="tab" aria-controls="pro" aria-selected="false">
...
<div class="tab-content row" id="pills-tabContent">
   ...
   <!-- Particulier -->
    <div class="tab-pane fade col-lg-7 col-md-12 {{ (!isset($societe) && !$errors->isEmpty() && !$errors->has('societe_id'))?'active show':'' }}" id="prt" role="tabpanel" aria-labelledby="prt-tab">

      {{ Form::open(array('url' => 'clients/create' , 'method' => 'post' ,
      ...
      {{ Form::close() }}
       ...
       <!-- Professionnel -->
    <div class="tab-pane fade col-lg-7 col-md-12 {{ (isset($societe) || (!$errors->isEmpty() && $errors->has('societe_id'))?'active show':'') }}" id="pro" role="tabpanel" aria-labelledby="pro-tab">
      
        {{ Form::open(array('url' => 'clients/create_' , 'method' => 'post' ,
