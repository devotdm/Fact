...
<ul class="navbar-nav bg-primary sidebar sidebar-dark accordion menu overflow-y-auto" id="accordionSidebar">
    ...
    <li class="nav-item {{ ($ind==='1')?'active':'' }}">
        ...
        <div id="CollapseClients" class="collapse" aria-labelledby="head\ingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="{{ url('clients/new') }}"><i class="fas fa-fw fa-plus-square text-success"></i><span>Ajouter un client</span></a>
                <a class="collapse-item" href="{{ url('clients/list') }}"><i class="fas fa-fw fa-tasks text-secondary"></i><span>Gérer les clients</span></a>
            </div>
        </div>
    </li>

    <li class="nav-item {{ ($ind==='2')?'active':'' }}">
        ...
        <div id="collapseSocietes" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="{{ url('societes/new') }}"><i class="fas fa-fw fa-plus-square text-success" ></i><span>Ajouter une société</span></a>
                <a class="collapse-item" href="{{ url('societes/list') }}"><i class="fas fa-fw fa-tasks text-secondary"></i><span>Gérer les sociétés</span></a>
            </div>
        </div>
    </li>

    <li class="nav-item {{ ($ind==='3')?'active':'' }}">
        ...
        <div id="CollapseDevis" class="collapse" aria-labelledby="head\ingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="{{ url('devis/new') }}"><i class="fas fa-fw fa-plus-square text-success" ></i><span>Ajouter un devis</span></a>
                <a class="collapse-item" href="{{ url('devis/list') }}"><i class="fas fa-fw fa-tasks text-secondary"></i><span>Gérer les devis</span></a>
            </div>
        </div>
    </li>

    <li class="nav-item {{ ($ind==='4')?'active':'' }}">
        ...
        <div id="collapseFactures" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="{{ url('factures/new') }}"><i class="fas fa-fw fa-plus-square text-success" ></i><span>Ajouter une facture</span></a>
                <a class="collapse-item" href="{{ url('factures/list') }}"><i class="fas fa-fw fa-tasks text-secondary"></i><span>Gérer les factures</span></a>
            </div>
        </div>
    </li>
