        ...
        <div class="card-header bg-white py-3 d-flex flex-row align-items-center justify-content-between">
            <span><h5 class="card-title mb-3 font-weight-bold text-dark">
                ...
                <?php if(isset($data->client->societe_id)): ?>
                 - <a class="text-dark" href="<?php echo e(url('societes/info/'.$data->client->societe_id)); ?>"><?php echo e($data->client->societe->nom); ?></a></h6>
                <?php endif; ?>
            </span>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH C:\xampp\htdocs\DEVOSOFT\Fact\resources\views///////includes/layouts/devis.blade.php ENDPATH**/ ?>