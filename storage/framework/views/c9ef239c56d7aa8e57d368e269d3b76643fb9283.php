<h3 class="text-dark mt-2">Destinataire</h3>
    <div class="form-group">
        ...
        <?php echo e(Form::select('client_id',$clients,null, ['class'=>'form-control w-50' , 'id' => 'destinataire'])); ?>
    ...
    <?php echo $__env->make($path.'includes.layouts.lignes',['articles' => $articles ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <?php /**PATH C:\xampp\htdocs\DEVOSOFT\Fact\resources\views////includes/layouts/forms/devis.blade.php ENDPATH**/ ?>