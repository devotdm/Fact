...
<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
    ...
    <li class="nav-item bg-white shadow mb-3 mr-4">
        <a class="nav-link p-3 pr-5 d-flex active" id="pro-tab" data-toggle="pill" href="#pro" role="tab" aria-controls="pro" aria-selected="false">
   ...
   <!-- Particulier -->
    <div class="tab-pane fade col-lg-7 col-md-12" id="prt" role="tabpanel" aria-labelledby="prt-tab">
      ...
      <?php echo e(Form::open(array('url' => 'clients/create' , 'method' => 'post' ,
        ...
        <?php echo $__env->make($path.'includes.layouts.forms.client1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
      ...
      <?php echo e(Form::close()); ?>
       ...
       <!-- Professionnel -->
    <div class="tab-pane fade col-lg-7 col-md-12 active show" id="pro" role="tabpanel" aria-labelledby="pro-tab">
      
        <?php echo e(Form::open(array('url' => 'clients/create_' , 'method' => 'post' ,
          'class' => "w-100" , 'name' => 'form2', 'id' => 'form2' ))); ?>


          <?php echo $__env->make($path.'includes.layouts.forms.client2',['societe' => $societe->id], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('struct', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\DEVOSOFT\Fact\resources\views/clients/add.blade.php ENDPATH**/ ?>