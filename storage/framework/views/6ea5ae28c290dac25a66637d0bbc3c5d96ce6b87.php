    ...
    <div class="card shadow mt-4" style="height: 13rem;">
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <span><h5 class="card-title mb-3 font-weight-bold text-dark"><a href="<?php echo e(url('clients/info/'.$data->id)); ?>"> <?php echo e($data->prenom.' '.$data->nom); ?> </a></h5>
                ...
                Particulier
                <?php else: ?>
                <a href="<?php echo e(url('societes/info')); ?>"> <?php echo e($data->societe_id); ?> </a>
                <?php endif; ?>
                </h6></span>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH C:\xampp\htdocs\DEVOSOFT\Fact\resources\views////includes/layouts/clients.blade.php ENDPATH**/ ?>