    ...
    <div class="card shadow mt-2">
        <div class="card-header bg-white py-3 d-flex flex-row align-items-center justify-content-between">
            ...
            <div class="dropdown no-arrow">
                <?php echo $__env->make($path.'includes.dropdown',['road' => 'factures'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
        </div>
        <div class="card-body">
            <span class="card-text"><i class="fas fa-sticky-note mr-2"></i><?php echo e($data->total_ttc.' '.$data->devise); ?></span>
            <span class="card-text ml-3"  title="crée le"><i class="far fa-clock mr-2"></i><?php echo e($data->created_at->format('d M Y')); ?></span>
            <?php if($data->statut=='payée'): ?>
                <span class="card-text ml-3" title="payée le"><i class="far fa-calendar-check mr-2"></i></i><?php echo e($data->created_at->format('d M Y')); ?></span>
            <?php endif; ?>
        </div>
    </div>
</div>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH C:\xampp\htdocs\DEVOSOFT\Fact\resources\views////factures/layouts/list.blade.php ENDPATH**/ ?>