...
<div class="line">
    ...
    <div class="form-row form-group line_row">
        ...
        <div class="col">
            ...
            <?php echo e(Form::input('number','total_ht[]','0', ['class'=>'form-control total_ht','readonly' => 'true'])); ?>
...
</div><?php /**PATH C:\xampp\htdocs\DEVOSOFT\Fact\resources\views////factures/layouts/lignes.blade.php ENDPATH**/ ?>