...
<?php echo e(Form::model($user,['url' => 'parametres/update' , 'method' => 'put'])); ?>
    ...
    <div class="form-group row">
     ...
     <div class="form-group row">
        ...
        <div class="col-md-6">
            <?php echo e(Form::input('text','societe',null, ['class'=>'form-control', 'id'=>'societe'])); ?>
    ...
    <div class="form-group row">
        ...
        <div class="col-md-6">
            <?php echo e(Form::input('text','code_cnss',null, ['class'=>'form-control', 'id'=>'code_cnss'])); ?>
   ...
   <div class="form-group row">
        ...
        <div class="col-md-6">
            ...
            <?php echo e(Form::textarea('adresse',null, ['rows' => '3' ,'class'=>'form-control', 'id'=>'adresse'])); ?>
   ...
   <div class="form-group row">
        ...
        <div class="col-md-6">
            <?php echo e(Form::input('text','pays',null, ['class'=>'form-control', 'id'=>'pays'])); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('parametres/struct', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\DEVOSOFT\Fact\resources\views/parametres/compte/edit.blade.php ENDPATH**/ ?>