...
<ul class="navbar-nav bg-primary sidebar sidebar-dark accordion menu" id="accordionSidebar">
    ...
    <li class="nav-item">
        ...
        <div id="collapseSocietes" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="<?php echo e(url('')); ?>"><i class="fas fa-fw fa-plus-square text-success" ></i><span>Ajouter une société</span></a>
                <a class="collapse-item" href="<?php echo e(url('clients/')); ?>"><i class="fas fa-fw fa-tasks text-secondary"></i><span>Gérer les sociétés</span></a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="CollapseDevis" class="collapse" aria-labelledby="head\ingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="<?php echo e(url('')); ?>"><i class="fas fa-fw fa-plus-square text-success" ></i><span>Ajouter un devis</span></a>
                <a class="collapse-item" href="<?php echo e(url('clients/')); ?>"><i class="fas fa-fw fa-tasks text-secondary"></i><span>Gérer les devis</span></a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="collapseFactures" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="<?php echo e(url('')); ?>"><i class="fas fa-fw fa-plus-square text-success" ></i><span>Ajouter une facture</span></a>
                <a class="collapse-item" href="<?php echo e(url('clients/')); ?>"><i class="fas fa-fw fa-tasks text-secondary"></i><span>Gérer les factures</span></a>
            </div>
        </div>
    </li>
