...
<ul class="navbar-nav bg-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
        ...
        <div id="CollapseClients" class="collapse" aria-labelledby="head\ingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="buttons.html">Ajouter un client</a>
                <a class="collapse-item" href="cards.html">Gérer les clients</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="collapseSocietes" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="buttons.html">Ajouter une société</a>
                <a class="collapse-item" href="cards.html">Gérer les sociétés</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="CollapseDevis" class="collapse" aria-labelledby="head\ingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="buttons.html">Ajouter un devis</a>
                <a class="collapse-item" href="cards.html">Gérer les devis</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="collapseFactures" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="buttons.html">Ajouter une facture</a>
                <a class="collapse-item" href="cards.html">Gérer les factures</a>
            </div>
        </div>
    </li>
...
<!-- End of Sidebar --><?php /**PATH C:\xampp\htdocs\DEVOSOFT\Fact\resources\views/menu.blade.php ENDPATH**/ ?>