...
<div class="col-lg-7">
    <form method="post" class="w-100 text-dark" id="form3">
        <div class="form-group mt-3">
            <h3 class="font-weight-bold">Informations</h3>
        </div>
        <div class="form-group">
            <label for="nom">Nom de la société : </label>
            <input type="text" class="form-control text-dark" name="nom" id="nom">
        ...
        <div class="form-group">
            ...
            <select multiple class="form-control" name="clients" id="clients">
                <option value=""></option>
            </select>
        </div>
        <div class="form-group">
