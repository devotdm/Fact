...
<script src="<?php echo e(asset('js/settings/toggle.js')); ?>"></script>
<script src="<?php echo e(asset('js/settings/num.js')); ?>"></script>

<?php $__env->stopSection(); ?>
<?php echo $__env->make('parametres/struct', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\DEVOSOFT\Fact\resources\views/parametres/preferences/numerotation.blade.php ENDPATH**/ ?>